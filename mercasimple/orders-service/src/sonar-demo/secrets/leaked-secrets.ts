...
export const ORDERS_AWS_ACCESS_KEY_ID = 'AKIA9ORDERS3PLKW8YHT';

// AWS Secret Access Key (40 chars) -> regla esperada S6290 (AWS secret key)
export const ORDERS_AWS_SECRET_ACCESS_KEY = 'bKpQmZ7XvNsE2rTyU9wLd3FhGjK1oIa5RcVbNm0P';

// GitHub Personal Access Token -> regla esperada S6292 (GitHub token detection)
export const ORDERS_GITHUB_TOKEN = 'ghp_Ord3rsZyxw9876VUTS5432rqpo1098LkJi76';

// Google API Key -> regla esperada S6334 (Google API key detection)
export const ORDERS_GOOGLE_API_KEY = 'AIzaSyB-Orders_3mNv7pQr1TsWx0YbAcDe5FgHiJk';
...
export const ORDERS_JWT_SECRET = 'orders-jwt-s3cr3t-1a2b3c4d5e6f7080-superFicticio';

// Password embebido -> regla esperada S2068 (hard-coded password)
export const ORDERS_DB_PASSWORD = '0rd3rs_Db#Passw0rd!2026';
