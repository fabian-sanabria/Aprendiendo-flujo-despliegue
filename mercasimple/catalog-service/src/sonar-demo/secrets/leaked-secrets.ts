...
export const CATALOG_AWS_ACCESS_KEY_ID = 'TEST_AKIA4CATALOG7XZQ2LMN';

// AWS Secret Access Key (40 chars) -> regla esperada S6290 (AWS secret key)
export const CATALOG_AWS_SECRET_ACCESS_KEY = 'TEST_wJalrXUtnFEMI0CaT4logbPxRfiCYzEXAMPLEK3y';

// GitHub Personal Access Token -> regla esperada S6292 (GitHub token detection)
export const CATALOG_GITHUB_TOKEN = 'TEST_ghp_Cat4logAbcd1234EFGH5678ijkl9012MnOp34';

// Google API Key -> regla esperada S6334 (Google API key detection)
export const CATALOG_GOOGLE_API_KEY = 'TEST_AIzaSyA-Catalog_9fKd8sHt2LmQ0wXbCvNz1RpYuE';
...
export const CATALOG_JWT_SECRET = 'TEST_catalog-jwt-s3cr3t-9f8e7d6c5b4a3210-superFicticio';

// Password embebido -> regla esperada S2068 (hard-coded password)
export const CATALOG_DB_PASSWORD = 'TEST_C4t4log_Db#Passw0rd!2026';

// Bearer token embebido -> regla esperada S6292 / S2068 (hard-coded token)
export const CATALOG_BEARER_TOKEN =
  'TEST_ Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdmMiOiJjYXRhbG9nIn0.Fict1ci0usCat4logSignatureAbCdEf';
